...
export default function RestaurantCard({ restaurant }: Props) {
  return (
    <Link
      ...
      target="_blank"
    >
      <div className="relative flex h-max w-full min-w-0 max-w-full cursor-pointer flex-col rounded-lg bg-white shadow hover:shadow-md transition-all duration-300 ease-out hover:scale-[103%]">
